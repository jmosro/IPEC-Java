...
import figurasgeometricas.volumen.CuboVolumen;
import formularios.*;
 ...
 * @version 1
*/
public class frm_cubo_volumen extends javax.swing.JFrame {

    frm_volumen volumen_formulario;
    
    public frm_cubo_volumen(frm_volumen volumen) {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/VolumenCubo.png"))); // NOI18N
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(lado)) {
            CuboVolumen cubo = new CuboVolumen();
            cubo.setLado(Double.parseDouble(lado));
            cubo.calcular();
            jtf_resultado.setText(String.format("%.1f", cubo.getResultado()).replace(',', '.'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_cubo_volumen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_cubo_volumen(new frm_volumen(new frm_principal())).setVisible(true);
            }
        });
    }
