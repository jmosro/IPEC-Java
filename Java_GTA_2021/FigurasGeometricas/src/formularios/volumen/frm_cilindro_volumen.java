...
import figurasgeometricas.volumen.CilindroVolumen;
import formularios.*;
 ...
 * @version 1
*/
public class frm_cilindro_volumen extends javax.swing.JFrame {

    frm_volumen volumen_formulario;
    
    public frm_cilindro_volumen(frm_volumen volumen) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Volumen - Cilindro");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/VolumenCilindro.png"))); // NOI18N

        jLabel4.setText("Radio:");

        jtf_radio.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jtf_radio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtf_radioActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_anterior, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jtf_radio, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        String radio = jtf_radio.getText();
        if(Utilidades.isValidacionCorrectaStringADouble(altura))
            if(Utilidades.isValidacionCorrectaStringADouble(radio)) {
                CilindroVolumen cilindro = new CilindroVolumen();
                cilindro.setAltura(Double.parseDouble(altura));
                cilindro.setRadio(Double.parseDouble(radio));
                cilindro.calcular();
                jtf_resultado.setText(String.format("%.1f", cilindro.getResultado()).replace(',', '.'));
                jtf_altura.setText(String.format("%.1f", Double.parseDouble(altura)).replace(',', '.'));
                jtf_radio.setText(String.format("%.1f", Double.parseDouble(radio)).replace(',', '.'));
            }
    ...
    private void jtf_radioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtf_radioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtf_radioActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_cilindro_volumen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_cilindro_volumen(new frm_volumen(new frm_principal())).setVisible(true);
            }
        });
    }
