...
import figurasgeometricas.volumen.EsferaVolumen;
import formularios.*;
 ...
 * @version 1
*/
public class frm_esfera_volumen extends javax.swing.JFrame {

    frm_volumen volumen_formulario;
    
    public frm_esfera_volumen(frm_volumen volumen) {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/VolumenEsfera.png"))); // NOI18N
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(radio)) {
            EsferaVolumen esfera = new EsferaVolumen();
            esfera.setRadio(Double.parseDouble(radio));
            esfera.calcular();
            jtf_resultado.setText(String.format("%.1f", esfera.getResultado()).replace(',', '.'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_esfera_volumen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_esfera_volumen(new frm_volumen(new frm_principal())).setVisible(true);
            }
        });
    }
