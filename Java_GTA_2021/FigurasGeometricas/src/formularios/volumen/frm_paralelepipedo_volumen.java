...
import figurasgeometricas.volumen.ParalelepipedoVolumen;
import formularios.*;
 ...
 * @version 1
*/
public class frm_paralelepipedo_volumen extends javax.swing.JFrame {

    frm_volumen volumen_formulario;
    
    public frm_paralelepipedo_volumen(frm_volumen volumen) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Volumen - Paralelepípedo");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/VolumenParalelepípedo.png"))); // NOI18N

        jLabel4.setText("Largo:");

        jtf_largo.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(jtf_largo, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        String largo = jtf_largo.getText();
        String base = jtf_base.getText();
        String altura = jtf_altura.getText();
        if(Utilidades.isValidacionCorrectaStringADouble(largo))
            if(Utilidades.isValidacionCorrectaStringADouble(base))
                if(Utilidades.isValidacionCorrectaStringADouble(altura)) {
                    ParalelepipedoVolumen paralelepipedo = new ParalelepipedoVolumen();
                    paralelepipedo.setLargo(Double.parseDouble(largo));
                    paralelepipedo.setBase(Double.parseDouble(base));
                    paralelepipedo.setAltura(Double.parseDouble(altura));
                    paralelepipedo.calcular();
                    jtf_resultado.setText(String.format("%.1f", paralelepipedo.getResultado()).replace(',', '.'));
                    jtf_largo.setText(String.format("%.1f", Double.parseDouble(largo)).replace(',', '.'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_paralelepipedo_volumen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_paralelepipedo_volumen(new frm_volumen(new frm_principal())).setVisible(true);
            }
        });
    }
