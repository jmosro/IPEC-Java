...
import figurasgeometricas.area.CirculoArea;
import formularios.*;
 ...
 * @version 1
*/
public class frm_circulo_area extends javax.swing.JFrame {

    frm_area area_formulario;
    
    public frm_circulo_area(frm_area area) {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ÁreaCírculo.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_circulo_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_circulo_area(new frm_area(new frm_principal())).setVisible(true);
            }
        });
    }
