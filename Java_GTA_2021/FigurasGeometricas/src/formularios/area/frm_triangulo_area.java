...
import figurasgeometricas.area.TrianguloArea;
import formularios.*;
 ...
 * @version 1
*/
public class frm_triangulo_area extends javax.swing.JFrame {

    frm_area area_formulario;
    
    public frm_triangulo_area(frm_area area) {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ÁreaTriángulo.png"))); // NOI18N

        jLabel4.setText("Base:");

        jtf_base.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jtf_base.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtf_baseActionPerformed(evt);
            }
        });
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(base))
            if(Utilidades.isValidacionCorrectaStringADouble(altura)) {
                TrianguloArea triangulo = new TrianguloArea();
    ...
    private void jtf_baseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtf_baseActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtf_baseActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_triangulo_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_triangulo_area(new frm_area(new frm_principal())).setVisible(true);
            }
        });
    }
