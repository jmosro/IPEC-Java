...
import figurasgeometricas.perimetro.RectanguloPerimetro;
import formularios.*;
 ...
 * @version 1
*/
public class frm_rectangulo_perimetro extends javax.swing.JFrame {

    frm_perimetro perimetro_formulario;
    
    public frm_rectangulo_perimetro(frm_perimetro perimetro) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Perímetro - Rectángulo");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/PerímetroRectángulo.png"))); // NOI18N
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(base))
            if(Utilidades.isValidacionCorrectaStringADouble(altura)) {
                RectanguloPerimetro rectangulo = new RectanguloPerimetro();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_rectangulo_perimetro(new frm_perimetro(new frm_principal())).setVisible(true);
            }
        });
    }
