...
import figurasgeometricas.perimetro.CirculoPerimetro;
import formularios.*;
 ...
 * @version 1
*/
public class frm_circulo_perimetro extends javax.swing.JFrame {

    frm_perimetro perimetro_formulario;
    
    public frm_circulo_perimetro(frm_perimetro perimetro) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Perímetro - Círculo");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/PerímetroCírculo.png"))); // NOI18N
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(radio)) {
            CirculoPerimetro circulo = new CirculoPerimetro();
            circulo.setRadio(Double.parseDouble(radio));
            circulo.calcular();
            jtf_resultado.setText(String.format("%.1f", circulo.getResultado()).replace(',', '.'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_circulo_perimetro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_circulo_perimetro(new frm_perimetro(new frm_principal())).setVisible(true);
            }
        });
    }
