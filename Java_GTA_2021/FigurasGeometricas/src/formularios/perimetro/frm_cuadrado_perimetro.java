...
import figurasgeometricas.perimetro.CuadradoPerimetro;
import formularios.*;
 ...
 * @version 1
*/
public class frm_cuadrado_perimetro extends javax.swing.JFrame {

    frm_perimetro perimetro_formulario;
    
    public frm_cuadrado_perimetro(frm_perimetro perimetro) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Perímetro - Cuadrado");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/PerímetroCuadrado.png"))); // NOI18N
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(lado)) {
            CuadradoPerimetro cuadrado = new CuadradoPerimetro();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_cuadrado_perimetro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_cuadrado_perimetro(new frm_perimetro(new frm_principal())).setVisible(true);
            }
        });
    }
