...
import figurasgeometricas.perimetro.RomboPerimetro;
import formularios.*;
 ...
 * @version 1
*/
public class frm_rombo_perimetro extends javax.swing.JFrame {

    frm_perimetro perimetro_formulario;
    
    public frm_rombo_perimetro(frm_perimetro perimetro) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Perímetro - Rombo");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/PerímetroRombo.png"))); // NOI18N
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        ...
        if(Utilidades.isValidacionCorrectaStringADouble(lado)) {
            RomboPerimetro rombo = new RomboPerimetro();
            rombo.setLado(Double.parseDouble(lado));
            rombo.calcular();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_rombo_perimetro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_rombo_perimetro(new frm_perimetro(new frm_principal())).setVisible(true);
            }
        });
    }
